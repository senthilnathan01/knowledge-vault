...
## Inbox
- `inbox/` — temporary captures and notes that still need sorting
- `inbox/Inbox.md` — inbox guide for triage and routing
...
- `templates/Research Brief.md` — research question and scope
