...
summary: >-
  Every day has a real constraint. Every decision has a cost. Every solved problem moves the company
  forward.
contentFormat: markdown
sourceContentFormat: markdown
sourceRepo: senthilnathan01.github.io
sourcePath: data/md_articles/i_am_choosing_hard_problems.md
sourceUrl: https://senthilnathan01.github.io/blog/i-am-choosing-hard-problems
...
# I Am Choosing Hard Problems

## 1
**I love problem solving.**

I mean the kind of problem that gets into your head and refuses to leave.
...
- Every day has a real constraint.
...
- I want work that puts weight on my name.
...
- I want to feel the company move when I push.
- I want to be in the room where the answer is still unclear and somebody has to figure it out.
...
I heard it was one of the highest-pressure rooms you could enter, and something in me respected that immediately.

I thought if I could survive there, everything else would feel possible.

The instinct was right.

- I was chasing pressure.
- I was chasing proof.
- I was chasing a room that would force me to become harder to kill.
...
If I believe in the mission, I cannot imagine being outworked.
...
- my attention should show it
- my output should show it
- my pain tolerance should show it
- my learning speed should show it
...
It could be a 10-person company. Or, it could be a team inside a much larger company.

I just care about the operating reality.
...
- it can make you keep doors open while the person inside you closes

I do not want that.

I would rather be known for choosing too clearly than spend my life being acceptable to people building nothing I respect.

Some paths need to close. Some versions of you need to end.

- the version that wants to be chosen before it chooses itself
...
- [Original published article](https://senthilnathan01.github.io/blog/i-am-choosing-hard-problems)
